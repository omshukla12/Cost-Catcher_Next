              ...
              <div className="w-full max-w-md space-y-4 animate-fade-in-up animation-delay-400">
                <form className="flex space-x-2">
                  <div className="relative flex-1">
                    <Input
                      className="w-full pl-10 pr-4 py-3 rounded-full bg-white/10 backdrop-blur-md text-white placeholder:text-white/70 focus:placeholder-transparent border-white/20 focus:border-none transition-all duration-300 focus:bg-white focus:text-primary"
